...
Users can search for movies and view details such as **title, release year, type, and poster** using the **OMDb API**.
...
- Gradient poster hover overlay for a cinematic effect

### ⚡ Performance & UX
- **Skeleton loading UI** while fetching movies
- **Broken image fallback** for missing posters
- Default poster used when API returns `"N/A"`

### 💾 Smart Features
- **Last searched movie saved in LocalStorage**
- Automatically loads the previous search on refresh
